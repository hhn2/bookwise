...
import {  FieldValues, useForm, UseFormReturn, DefaultValues, SubmitHandler, Path } from 'react-hook-form';
  ...
  if (result.success) {
    ...
    <div className = "flex flex-col gap-4">
        <h1 className = "text-2xl font-semibold text-white">
            {isSignIn ? "Welcome back to BookWise": "Create your library account"}</h1>
            ...
            <FormItem>
              ...
              <FormControl>
                {field.name === "universityCard" ? (
                    ...
                    placeholder = "Upload your ID" folder="ids" variant="dark"
